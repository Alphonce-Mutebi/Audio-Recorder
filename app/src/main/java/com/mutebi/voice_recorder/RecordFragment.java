    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.record_button:
                if (isRecording) {
                    stopRecording();
                    recordBtn.setImageDrawable(getResources().getDrawable(R.drawable.ic_record_btn_stopped, null));
                    isRecording = false;

                } else {
                    if (checkPermissions()) {
                        startRecording();
                        recordBtn.setImageDrawable(getResources().getDrawable(R.drawable.ic_record_button_recording, null));
                        isRecording = true;
                    }
                }
                break;
